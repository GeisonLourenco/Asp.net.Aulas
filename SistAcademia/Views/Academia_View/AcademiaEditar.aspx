<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AcademiaEditar.aspx.cs" Inherits="SistAcademia.Views.Academia_View.AcademiaEditar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class ="form-group">
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:BaseDadosAcademiaDBConnectionString %>" SelectCommand="SELECT [Id], [Nome], [Endereco], [Telefone], [Professor] FROM [Academias]"></asp:SqlDataSource>
        <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
